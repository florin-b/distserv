...
public class User {
	...
	public boolean isDepozit2() {
		return isDepozit2;
	}

	public void setDepozit2(boolean isDepozit2) {
		this.isDepozit2 = isDepozit2;
	}
	...
	public String toString() {
		return "User [nume=" + nume + ", filiala=" + filiala + ", codPers=" + codPers + ", codDepart=" + codDepart
				...
				+ ", tipAcces=" + tipAcces + ", unitLog=" + unitLog + ", isDepozit2=" + isDepozit2 + "]";
	}
